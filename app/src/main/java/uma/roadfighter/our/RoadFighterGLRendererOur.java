...
import RoadFighter_sequential.RoadFighter;
import uma.roadfighter.R;
import uma.roadfighter.model.RoadFighter_Implementation;

public class RoadFighterGLRendererOur implements GLSurfaceView.Renderer {
    // Events
    public char event;
    // Dialog
    ...
    float totalTime;
    // Game
    private RoadFighter_Implementation RoadFighter = new RoadFighter_Implementation();
    private RoadFighter RoadFighter2 = new RoadFighter();
    // User Car
    private int carLow, carHigh;
    // Obstacles and Opponents
    private int nObstacles, nOpponents;
    // Random Generator
    ...
    public RoadFighterGLRendererOur(Context c) {
        super();
        context = c;
